...
import horspoolPattern.HorspoolChord;
import horspoolPattern.HorspoolTestChord;
import horspoolPattern.PositionPatternChord;
...
public final class ChordStructureRecognition {
    ...
    public static void main(String args[]) throws IOException {
        ...
        int count = 0;
        try {
            try (BufferedReader in = new BufferedReader(new FileReader("listMineracao.txt"))) {
                String str;
                while ((str = in.readLine()) != null) {
                    ...
                    try {
                        if (str != null) {
                            ...
                            ChordStructureRecognition chordRecognitionByTonality = new ChordStructureRecognition();
                            chordRecognitionByTonality.readMidi(str);
                            
                            List<String> listChordsWrite = new ArrayList<>();
                            listChordsWrite = chordRecognitionByTonality.getListChords2();
                            ...
                            //BufferedImage bi = horspoolTest.createImage2(colors);
                            
                            List<PositionPatternChord> listPositionPattern = horspoolTest.calculateColorPositions(listHorspool, listChordsWrite);
                            //BufferedImage bi = horspoolTest.createImageWithDominantChord(listPositionPattern);
                            ...
                            HorspoolTestChord.saveImage(bi, "../../../../prueba/" + String.valueOf(count) + ".png");
                            ...
                            for (int t = 0; t < chordRecognitionByTonality.histogramNotes.size(); t++) {
                                if (t == chordRecognitionByTonality.histogramNotes.size() - 1) {
                                    result1 = result1 + chordRecognitionByTonality.histogramNotes.get(t);
                                } else {
                                    result1 = result1 + chordRecognitionByTonality.histogramNotes.get(t) + ";";
                                }
                            }
        ...
        FileWriter fData = new FileWriter("sequenceMineracao.data");
        ...
        FileWriter fLabel = new FileWriter("sequenceMineracao.label");
        ...
        outLabel.close();
        System.out.println("acabo");
        fData = new FileWriter("histogramMineracao.data");
        outData = new BufferedWriter(fData);
        outData.write("DY\n");
        outData.write(String.valueOf(listStringHistogram.size()) + "\n");
        outData.write("12\n");
        outData.write("c;cs;d;ds;e;f;fs;g;gs;a;as;b" + "\n");
        ...
        fLabel = new FileWriter("histogramMineracao.label");
