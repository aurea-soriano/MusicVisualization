 ...
 * @author aurea
 */
public final class PreprocMusicStructure {
    ...
    public static void process() throws IOException{
        ...
        try {
            try (BufferedReader in = new BufferedReader(new FileReader("listMineracao.txt"))) {
                ...
                while ((str = in.readLine()) != null) {
                    ...
                    try {
                        if (str != null) {
                            PreprocMusicStructure preprocMusicStructure = new PreprocMusicStructure();
                            preprocMusicStructure.readMidi(str);
                            List<String> listChordsWrite = new ArrayList<>();
                            listChordsWrite = preprocMusicStructure.getListChords2();
                            ...
                            for (int t = 0; t < preprocMusicStructure.histogramNotes.size(); t++) {
                                if (t == preprocMusicStructure.histogramNotes.size() - 1) {
                                    result1 = result1 + preprocMusicStructure.histogramNotes.get(t);
                                } else {
                                    result1 = result1 + preprocMusicStructure.histogramNotes.get(t) + ";";
                                }
                            }
        ...
        FileWriter fData = new FileWriter("collection.data");
        ...
        FileWriter fLabel = new FileWriter("collection.label");
